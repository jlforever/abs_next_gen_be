module CoursesSeeders
  class S20220107
    ...
    KLASSES = {
      'Chinese - 基础汉语1班（快班/大班) - 宝宝老师' => ['CHN-100-SP22', 1700, 6250, 'Zoom', 18, 'Mon', '22:00', '55', 18],
      'Chinese - 基础汉语2班（慢班/小班) - 苗苗老师' => ['CHN-200-SP22', 2500, 6250, 'Zoom', 18, 'Tue', '22:00', '55', 7],
      'Chinese - 基础汉语5班（快班/大班) - 宝宝老师' => ['CHN-500-SP22', 1700, 6250, 'Zoom', 18, 'Thu', '23:00', '55', 18],
      'Chinese - 基础汉语6班（慢班/小班) - 苗苗老师' => ['CHN-600-SP22', 2500, 6000, 'Zoom', 18, 'Sat', '22:00', '55', 7],
      'Chinese - 基础汉语当周复习课1 - 苗苗老师' => ['CHN-800-SP22', 1500, 4750, 'Zoom', 18, 'Wed', '22:30', '60', 12],
      'Chinese - 跟着小栗子学中文 - Serena老师' => ['CHN-1010-SP22', 1500, 6000, 'Zoom', 18, 'Sat', '15:00', '90', 24],
      'Chinese - 中文说起来 - Sarah老师' => ['CHN-1030-SP22', 1700, 6000, 'Zoom', 18, 'Sun', '21:00', '60', 10],
    }.freeze

    VACAYS = {
      'CHN-100-SP22' => ['2022-02-21', '2022-04-18'],
      'CHN-200-SP22' => ['2022-02-22', '2022-04-19'],
      'CHN-500-SP22' => ['2022-02-24', '2022-04-21'],
      'CHN-600-SP22' => ['2022-02-26', '2022-04-23'],
      'CHN-800-SP22' => ['2022-02-23', '2022-04-20'],
      'CHN-1010-SP22' => ['2022-02-26', '2022-04-23'],
      'CHN-1030-SP22' => ['2022-02-27', '2022-04-24']
    }.freeze

    EFFECTIVE_FROM = '2022-02-07 09:00:00'
    EFFECTIVE_UNTIL = '2022-06-26'

    REG_EFFECTIVE_FROM = '2022-01-10'
    REG_EFFECTIVE_UNTIL = '2022-06-18'
